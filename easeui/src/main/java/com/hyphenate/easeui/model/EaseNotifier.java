...
public class EaseNotifier {
    ...
    protected void sendNotification(EMMessage message, boolean isForeground, boolean numIncrease) {
        ...
        try {
            ...
            Intent msgIntent = new Intent("com.mm.kyys.ChatActivity");
            String tousername = message.getUserName();
            ...
            msgIntent.putExtra(EaseConstant.EXTRA_USER_ID,tousername);
            msgIntent.putExtra(EaseConstant.EXTRA_CHAT_TYPE, EMMessage.ChatType.Chat);
            msgIntent.putExtra(EaseConstant.EXTRA_USER_NICK,touserNick);
            if (notificationInfoProvider != null) {
